...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        data transformation is done in this function
        ...
        try:
            ...
            logging.info("numerical data Processed")
            ...
            logging.info("Categorical data processed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("redaed Train and Test Data")
            ...
            logging.info("Combined the preprocessed data ")

            save_object(
                file_path=self.data_Trasnsformation_config.preprocessor_obj_file_path,
            ...
            return(
                train_arr,
                test_arr,
                self.data_Trasnsformation_config.preprocessor_obj_file_path,
            )
        except Exception as e:
            raise Custom_exception(e,sys)